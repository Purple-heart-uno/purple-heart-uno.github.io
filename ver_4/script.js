...
const genres = [
    ...
    { id: 'fantasy', name: "Фэнтези", image: "https://cdn-icons-png.flaticon.com/512/4237/4237000.png" },
    { id: 'horror', name: "Ужасы", image: "https://cdn-icons-png.flaticon.com/512/4237/4237000.png" },
    { id: 'sci-fi', name: "Фантастика", image: "https://cdn-icons-png.flaticon.com/512/4237/4237000.png" }
];
...
function excludeGenre() {
    ...
    const genreWidth = 200;
    const extraSpins = 2;
    const randomIndex = Math.floor(Math.random() * session.availableGenres.length);
    const targetPosition = -(randomIndex * genreWidth + extraSpins * session.availableGenres.length * genreWidth);
...
function excludeMovie() {
    ...
    const targetPosition = -(randomIndex * movieWidth + extraSpins * session.availableMovies.length * movieWidth);
